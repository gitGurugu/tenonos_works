BEGIN {
	...
	print "UK_SYSCALL_USC_PROLOGUE_DEFINE(uk_syscall6_r, uk_syscall6_r_reg_map_linuxabi,"
	print "\t\t\t\t14, long, nr, long, arg1, long, arg2, long, arg3, long, arg4, long, arg5, long, arg6)";
	print "\nlong __used uk_syscall6_r_reg_map_linuxabi(struct uk_syscall_ctx *usc)"
	print "\n{"
	print "\n\tusc->regs.rsyscall = usc->regs.x[0];"
	for (i = 0; i < 6; i++)
		printf("\n\tusc->regs.rarg%d = usc->regs.x[%d];", i, i+1)
	print "\n\treturn uk_syscall6_r_u(usc);"
	print "\n}\n"
